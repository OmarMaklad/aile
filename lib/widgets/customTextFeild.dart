...
class CustomTextField extends StatefulWidget {
  ...
  CustomTextField({ this.hint, this.onsave, this.onTap,
    this.icon, this.type,  this.valid,  this.controller, this.focus, this.dIcon, this.label, this.read, this.eIcon, this.edit, this.isEdit, this.line, this.labelText,});
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(widget.dIcon,color: kTextColor,),
          labelText: widget.label==true?widget.labelText:null,
          icon: widget.isEdit==true?Icon(Icons.edit):null,
          labelStyle: TextStyle(fontSize: 14,color: kTextColor,fontFamily: "dinnextl bold",),
